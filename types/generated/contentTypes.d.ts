...
export interface ApiAccessibilityFeatureAccessibilityFeature
  ...
  attributes: {
    app_users: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    ticket_types: Schema.Attribute.Relation<
      'oneToMany',
      'api::ticket-type.ticket-type'
    >;
    tickets: Schema.Attribute.Relation<'oneToMany', 'api::ticket.ticket'>;
...
export interface ApiLocationLocation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    contact_details: Schema.Attribute.Blocks;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Blocks;
    event_location: Schema.Attribute.Relation<'oneToMany', 'api::event.event'>;
    ...
    >;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    opening_hours: Schema.Attribute.Blocks;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiTicketTicket extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    companion: Schema.Attribute.Component<'ticket.companion', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    event: Schema.Attribute.Relation<'oneToOne', 'api::event.event'>;
    format: Schema.Attribute.Enumeration<['digital', 'physical', 'mobile']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::ticket.ticket'
    ...
    publishedAt: Schema.Attribute.DateTime;
    refund_policy: Schema.Attribute.Blocks;
